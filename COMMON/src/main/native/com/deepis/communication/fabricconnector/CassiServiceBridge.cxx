...
FabricCassiBridgeCb* singletonCassiServiceBridge(FabricCassiMessageQueue* pcCommon, voidptr pCtx) {
        DEEP_LOG_DEBUG(OTHER, "Creating CassiServiceBridge queue %p\n", pcCommon);

        return CassiServiceBridge::getInstance(pcCommon);
}
