...
# Turn on libzmq support
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DLIBZMQ")

# Turn on txObject support
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DTXOBJECT")

# Turn this flag on to extra packing for multibyte character sets
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DDEEP_MULTIBYTE_PACK")

# Turn this flag on to support distributed / deep fabric
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DDEEP_DISTRIBUTED")
